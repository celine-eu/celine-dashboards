...
T = TypeVar("T", bound="ReportExecutionLogRestApiGetList")
...
class ReportExecutionLogRestApiGetList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        report_execution_log_rest_api_get_list = cls(
            scheduled_dttm=scheduled_dttm,
            state=state,
            end_dttm=end_dttm,
        ...
        report_execution_log_rest_api_get_list.additional_properties = d
        return report_execution_log_rest_api_get_list
