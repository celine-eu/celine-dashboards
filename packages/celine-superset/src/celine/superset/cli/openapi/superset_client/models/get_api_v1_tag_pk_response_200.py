...
if TYPE_CHECKING:
    from ..models.get_api_v1_tag_pk_response_200_description_columns import GetApiV1TagPkResponse200DescriptionColumns
    from ..models.get_api_v1_tag_pk_response_200_label_columns import GetApiV1TagPkResponse200LabelColumns
    from ..models.tag_rest_api_get import TagRestApiGet


T = TypeVar("T", bound="GetApiV1TagPkResponse200")


@_attrs_define
class GetApiV1TagPkResponse200:
    """
    Attributes:
        description_columns (GetApiV1TagPkResponse200DescriptionColumns | Unset):
        id (str | Unset): The item id
        label_columns (GetApiV1TagPkResponse200LabelColumns | Unset):
        result (TagRestApiGet | Unset):
    ...
    description_columns: GetApiV1TagPkResponse200DescriptionColumns | Unset = UNSET
    id: str | Unset = UNSET
    label_columns: GetApiV1TagPkResponse200LabelColumns | Unset = UNSET
    result: TagRestApiGet | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_api_v1_tag_pk_response_200_description_columns import (
        ...
        if isinstance(_description_columns, Unset):
            ...
            description_columns = GetApiV1TagPkResponse200DescriptionColumns.from_dict(_description_columns)
        ...
        if isinstance(_label_columns, Unset):
            ...
            label_columns = GetApiV1TagPkResponse200LabelColumns.from_dict(_label_columns)
        ...
        get_api_v1_tag_pk_response_200.additional_properties = d
        return get_api_v1_tag_pk_response_200
