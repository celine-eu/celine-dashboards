...
from ..models.database_rest_api_put_configuration_method import (
    DatabaseRestApiPutConfigurationMethod,
    check_database_rest_api_put_configuration_method,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.database_rest_api_put_parameters import DatabaseRestApiPutParameters
    from ..models.database_ssh_tunnel import DatabaseSSHTunnel


T = TypeVar("T", bound="DatabaseRestApiPut")
...
class DatabaseRestApiPut:
    ...
    Attributes:
        ...
        configuration_method (DatabaseRestApiPutConfigurationMethod | Unset): Configuration_method is used on the
        ...
        parameters (DatabaseRestApiPutParameters | Unset): DB-specific parameters for configuration
    ...
    configuration_method: DatabaseRestApiPutConfigurationMethod | Unset = "sqlalchemy_form"
    ...
    parameters: DatabaseRestApiPutParameters | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        configuration_method: DatabaseRestApiPutConfigurationMethod | Unset
        if isinstance(_configuration_method, Unset):
            configuration_method = UNSET
        else:
            configuration_method = check_database_rest_api_put_configuration_method(_configuration_method)
        ...
        parameters: DatabaseRestApiPutParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = DatabaseRestApiPutParameters.from_dict(_parameters)
        ...
        database_rest_api_put.additional_properties = d
        return database_rest_api_put
