...
if TYPE_CHECKING:
    from ..models.superset_user_api_get_list_group import SupersetUserApiGetListGroup
    from ..models.superset_user_api_get_list_role import SupersetUserApiGetListRole
    from ..models.superset_user_api_get_list_user import SupersetUserApiGetListUser
    from ..models.superset_user_api_get_list_user_1 import SupersetUserApiGetListUser1


T = TypeVar("T", bound="SupersetUserApiGetList")


@_attrs_define
class SupersetUserApiGetList:
    """
    Attributes:
        email (str):
        first_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_changed_by, Unset):
            ...
            changed_by = SupersetUserApiGetListUser1.from_dict(_changed_by)
        ...
        if isinstance(_created_by, Unset):
            ...
            created_by = SupersetUserApiGetListUser.from_dict(_created_by)
        ...
        if isinstance(_groups, Unset):
            ...
            groups = SupersetUserApiGetListGroup.from_dict(_groups)
        ...
        if isinstance(_roles, Unset):
            ...
            roles = SupersetUserApiGetListRole.from_dict(_roles)

        superset_user_api_get_list = cls(
            email=email,
            first_name=first_name,
            last_name=last_name,
            username=username,
        ...
        superset_user_api_get_list.additional_properties = d
        return superset_user_api_get_list
