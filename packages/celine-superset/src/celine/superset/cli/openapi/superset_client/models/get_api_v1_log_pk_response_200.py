...
if TYPE_CHECKING:
    from ..models.get_api_v1_log_pk_response_200_description_columns import GetApiV1LogPkResponse200DescriptionColumns
    from ..models.get_api_v1_log_pk_response_200_label_columns import GetApiV1LogPkResponse200LabelColumns
    from ..models.log_rest_api_get import LogRestApiGet


T = TypeVar("T", bound="GetApiV1LogPkResponse200")


@_attrs_define
class GetApiV1LogPkResponse200:
    """
    Attributes:
        description_columns (GetApiV1LogPkResponse200DescriptionColumns | Unset):
        id (str | Unset): The item id
        label_columns (GetApiV1LogPkResponse200LabelColumns | Unset):
        result (LogRestApiGet | Unset):
    ...
    description_columns: GetApiV1LogPkResponse200DescriptionColumns | Unset = UNSET
    id: str | Unset = UNSET
    label_columns: GetApiV1LogPkResponse200LabelColumns | Unset = UNSET
    result: LogRestApiGet | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_api_v1_log_pk_response_200_description_columns import (
        ...
        if isinstance(_description_columns, Unset):
            ...
            description_columns = GetApiV1LogPkResponse200DescriptionColumns.from_dict(_description_columns)
        ...
        if isinstance(_label_columns, Unset):
            ...
            label_columns = GetApiV1LogPkResponse200LabelColumns.from_dict(_label_columns)
        ...
        get_api_v1_log_pk_response_200.additional_properties = d
        return get_api_v1_log_pk_response_200
