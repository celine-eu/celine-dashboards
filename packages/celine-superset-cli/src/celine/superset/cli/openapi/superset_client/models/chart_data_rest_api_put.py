...
from ..models.chart_data_rest_api_put_datasource_type_type_1 import (
    ChartDataRestApiPutDatasourceTypeType1,
    check_chart_data_rest_api_put_datasource_type_type_1,
)
from ..models.chart_data_rest_api_put_datasource_type_type_2_type_1 import (
    ChartDataRestApiPutDatasourceTypeType2Type1,
    check_chart_data_rest_api_put_datasource_type_type_2_type_1,
)
from ..models.chart_data_rest_api_put_datasource_type_type_3_type_1 import (
    ChartDataRestApiPutDatasourceTypeType3Type1,
    check_chart_data_rest_api_put_datasource_type_type_3_type_1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ChartDataRestApiPut")
...
class ChartDataRestApiPut:
    ...
    Attributes:
        ...
        datasource_id (int | None | Unset): The id of the dataset/datasource this new chart will use. A complete
            datasource identification needs `datasource_id` and `datasource_type`.
        datasource_type (ChartDataRestApiPutDatasourceTypeType1 | ChartDataRestApiPutDatasourceTypeType2Type1 |
            ChartDataRestApiPutDatasourceTypeType3Type1 | None | Unset): The type of dataset/datasource identified on
            `datasource_id`.
        ...
        slice_name (None | str | Unset): The name of the chart.
        tags (list[int] | Unset):
        uuid (None | Unset | UUID):
        viz_type (None | str | Unset): The type of chart visualization used. Example: ['bar', 'area', 'table'].
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.datasource_type, str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_datasource_type(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                datasource_type_type_1 = check_chart_data_rest_api_put_datasource_type_type_1(data)

                return datasource_type_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            try:
                if not isinstance(data, str):
                    raise TypeError()
                datasource_type_type_2_type_1 = check_chart_data_rest_api_put_datasource_type_type_2_type_1(data)

                return datasource_type_type_2_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            try:
                if not isinstance(data, str):
                    raise TypeError()
                datasource_type_type_3_type_1 = check_chart_data_rest_api_put_datasource_type_type_3_type_1(data)

                return datasource_type_type_3_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(
                ChartDataRestApiPutDatasourceTypeType1
        ...
        chart_data_rest_api_put.additional_properties = d
        return chart_data_rest_api_put
