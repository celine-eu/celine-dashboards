...
from ..models.chart_rest_api_put_datasource_type_type_1 import (
    ChartRestApiPutDatasourceTypeType1,
    check_chart_rest_api_put_datasource_type_type_1,
)
from ..models.chart_rest_api_put_datasource_type_type_2_type_1 import (
    ChartRestApiPutDatasourceTypeType2Type1,
    check_chart_rest_api_put_datasource_type_type_2_type_1,
)
from ..models.chart_rest_api_put_datasource_type_type_3_type_1 import (
    ChartRestApiPutDatasourceTypeType3Type1,
    check_chart_rest_api_put_datasource_type_type_3_type_1,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ChartRestApiPut")
...
class ChartRestApiPut:
    ...
    Attributes:
        ...
        datasource_type (ChartRestApiPutDatasourceTypeType1 | ChartRestApiPutDatasourceTypeType2Type1 |
            ChartRestApiPutDatasourceTypeType3Type1 | None | Unset): The type of dataset/datasource identified on
            `datasource_id`.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_datasource_type(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                datasource_type_type_1 = check_chart_rest_api_put_datasource_type_type_1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                datasource_type_type_2_type_1 = check_chart_rest_api_put_datasource_type_type_2_type_1(data)
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                datasource_type_type_3_type_1 = check_chart_rest_api_put_datasource_type_type_3_type_1(data)
        ...
        chart_rest_api_put.additional_properties = d
        return chart_rest_api_put
