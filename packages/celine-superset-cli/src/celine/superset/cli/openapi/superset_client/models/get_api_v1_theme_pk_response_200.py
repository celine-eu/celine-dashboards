...
if TYPE_CHECKING:
    from ..models.get_api_v1_theme_pk_response_200_description_columns import (
        GetApiV1ThemePkResponse200DescriptionColumns,
    )
    from ..models.get_api_v1_theme_pk_response_200_label_columns import GetApiV1ThemePkResponse200LabelColumns
    from ..models.theme_rest_api_get import ThemeRestApiGet


T = TypeVar("T", bound="GetApiV1ThemePkResponse200")


@_attrs_define
class GetApiV1ThemePkResponse200:
    """
    Attributes:
        description_columns (GetApiV1ThemePkResponse200DescriptionColumns | Unset):
        id (str | Unset): The item id
        label_columns (GetApiV1ThemePkResponse200LabelColumns | Unset):
        result (ThemeRestApiGet | Unset):
    ...
    description_columns: GetApiV1ThemePkResponse200DescriptionColumns | Unset = UNSET
    id: str | Unset = UNSET
    label_columns: GetApiV1ThemePkResponse200LabelColumns | Unset = UNSET
    result: ThemeRestApiGet | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description_columns, Unset):
            ...
            description_columns = GetApiV1ThemePkResponse200DescriptionColumns.from_dict(_description_columns)
        ...
        if isinstance(_label_columns, Unset):
            ...
            label_columns = GetApiV1ThemePkResponse200LabelColumns.from_dict(_label_columns)
        ...
        get_api_v1_theme_pk_response_200.additional_properties = d
        return get_api_v1_theme_pk_response_200
