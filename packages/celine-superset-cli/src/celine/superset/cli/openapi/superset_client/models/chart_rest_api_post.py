...
from ..models.chart_rest_api_post_datasource_type import (
    ChartRestApiPostDatasourceType,
    check_chart_rest_api_post_datasource_type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ChartRestApiPost")
...
class ChartRestApiPost:
    ...
    Attributes:
        ...
        datasource_type (ChartRestApiPostDatasourceType): The type of dataset/datasource identified on `datasource_id`.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        datasource_type = check_chart_rest_api_post_datasource_type(d.pop("datasource_type"))
        ...
        chart_rest_api_post.additional_properties = d
        return chart_rest_api_post
