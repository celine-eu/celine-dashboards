...
if TYPE_CHECKING:
    from ..models.get_api_v1_saved_query_response_200_description_columns import (
        GetApiV1SavedQueryResponse200DescriptionColumns,
    )
    from ..models.get_api_v1_saved_query_response_200_label_columns import GetApiV1SavedQueryResponse200LabelColumns
    from ..models.saved_query_rest_api_get_list import SavedQueryRestApiGetList


T = TypeVar("T", bound="GetApiV1SavedQueryResponse200")


@_attrs_define
class GetApiV1SavedQueryResponse200:
    """
    Attributes:
        count (float | Unset): The total record count on the backend
        description_columns (GetApiV1SavedQueryResponse200DescriptionColumns | Unset):
        ids (list[str] | Unset): A list of item ids, useful when you don't know the column id
        label_columns (GetApiV1SavedQueryResponse200LabelColumns | Unset):
        ...
        result (list[SavedQueryRestApiGetList] | Unset): The result from the get list query
    """

    count: float | Unset = UNSET
    description_columns: GetApiV1SavedQueryResponse200DescriptionColumns | Unset = UNSET
    ids: list[str] | Unset = UNSET
    label_columns: GetApiV1SavedQueryResponse200LabelColumns | Unset = UNSET
    list_columns: list[str] | Unset = UNSET
    list_title: str | Unset = UNSET
    order_columns: list[str] | Unset = UNSET
    result: list[SavedQueryRestApiGetList] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description_columns, Unset):
            ...
            description_columns = GetApiV1SavedQueryResponse200DescriptionColumns.from_dict(_description_columns)
        ...
        if isinstance(_label_columns, Unset):
            ...
            label_columns = GetApiV1SavedQueryResponse200LabelColumns.from_dict(_label_columns)
        ...
        if _result is not UNSET:
            ...
            for result_item_data in _result:
                result_item = SavedQueryRestApiGetList.from_dict(result_item_data)

                result.append(result_item)

        get_api_v1_saved_query_response_200 = cls(
            count=count,
        ...
        get_api_v1_saved_query_response_200.additional_properties = d
        return get_api_v1_saved_query_response_200
