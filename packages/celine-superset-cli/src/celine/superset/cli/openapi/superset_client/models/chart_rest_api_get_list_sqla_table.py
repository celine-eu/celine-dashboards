...
T = TypeVar("T", bound="ChartRestApiGetListSqlaTable")
...
class ChartRestApiGetListSqlaTable:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chart_rest_api_get_list_sqla_table = cls(
            table_name=table_name,
            default_endpoint=default_endpoint,
        )

        chart_rest_api_get_list_sqla_table.additional_properties = d
        return chart_rest_api_get_list_sqla_table
