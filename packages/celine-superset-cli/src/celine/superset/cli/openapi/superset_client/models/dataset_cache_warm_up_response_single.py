...
T = TypeVar("T", bound="DatasetCacheWarmUpResponseSingle")


@_attrs_define
class DatasetCacheWarmUpResponseSingle:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_cache_warm_up_response_single = cls(
            chart_id=chart_id,
            viz_error=viz_error,
            viz_status=viz_status,
        )

        dataset_cache_warm_up_response_single.additional_properties = d
        return dataset_cache_warm_up_response_single
