...
from ..models.tag_rest_api_get_list_type import TagRestApiGetListType, check_tag_rest_api_get_list_type
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.tag_rest_api_get_list_user import TagRestApiGetListUser
    from ..models.tag_rest_api_get_list_user_1 import TagRestApiGetListUser1


T = TypeVar("T", bound="TagRestApiGetList")


@_attrs_define
class TagRestApiGetList:
    """
    Attributes:
        changed_by (TagRestApiGetListUser | Unset):
        changed_on_delta_humanized (Any | Unset):
        created_by (TagRestApiGetListUser1 | Unset):
        created_on_delta_humanized (Any | Unset):
        description (None | str | Unset):
        id (int | Unset):
        name (None | str | Unset):
        type_ (TagRestApiGetListType | Unset):
    """

    changed_by: TagRestApiGetListUser | Unset = UNSET
    changed_on_delta_humanized: Any | Unset = UNSET
    created_by: TagRestApiGetListUser1 | Unset = UNSET
    created_on_delta_humanized: Any | Unset = UNSET
    description: None | str | Unset = UNSET
    id: int | Unset = UNSET
    name: None | str | Unset = UNSET
    type_: TagRestApiGetListType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_changed_by, Unset):
            ...
            changed_by = TagRestApiGetListUser.from_dict(_changed_by)
        ...
        if isinstance(_created_by, Unset):
            ...
            created_by = TagRestApiGetListUser1.from_dict(_created_by)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_tag_rest_api_get_list_type(_type_)

        tag_rest_api_get_list = cls(
        ...
        tag_rest_api_get_list.additional_properties = d
        return tag_rest_api_get_list
