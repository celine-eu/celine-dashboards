...
T = TypeVar("T", bound="DatasetRestApiGetListDatabase")
...
class DatasetRestApiGetListDatabase:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_rest_api_get_list_database = cls(
            database_name=database_name,
            id=id,
            uuid=uuid,
        )

        dataset_rest_api_get_list_database.additional_properties = d
        return dataset_rest_api_get_list_database
