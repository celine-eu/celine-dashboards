...
if TYPE_CHECKING:
    from ..models.chart_data_rest_api_get_list_dashboard import ChartDataRestApiGetListDashboard
    from ..models.chart_data_rest_api_get_list_sqla_table import ChartDataRestApiGetListSqlaTable
    from ..models.chart_data_rest_api_get_list_tag import ChartDataRestApiGetListTag
    from ..models.chart_data_rest_api_get_list_user import ChartDataRestApiGetListUser
    from ..models.chart_data_rest_api_get_list_user_1 import ChartDataRestApiGetListUser1
    from ..models.chart_data_rest_api_get_list_user_2 import ChartDataRestApiGetListUser2
    from ..models.chart_data_rest_api_get_list_user_3 import ChartDataRestApiGetListUser3


T = TypeVar("T", bound="ChartDataRestApiGetList")
...
class ChartDataRestApiGetList:
    ...
    Attributes:
        ...
        last_saved_by (ChartDataRestApiGetListUser2 | Unset):
        owners (ChartDataRestApiGetListUser3 | Unset):
        params (None | str | Unset):
        slice_name (None | str | Unset):
        slice_url (Any | Unset):
        table (ChartDataRestApiGetListSqlaTable | Unset):
        tags (ChartDataRestApiGetListTag | Unset):
    ...
    changed_by: ChartDataRestApiGetListUser | Unset = UNSET
    ...
    created_by: ChartDataRestApiGetListUser1 | Unset = UNSET
    created_by_name: Any | Unset = UNSET
    created_on_delta_humanized: Any | Unset = UNSET
    dashboards: ChartDataRestApiGetListDashboard | Unset = UNSET
    ...
    last_saved_by: ChartDataRestApiGetListUser2 | Unset = UNSET
    owners: ChartDataRestApiGetListUser3 | Unset = UNSET
    params: None | str | Unset = UNSET
    slice_name: None | str | Unset = UNSET
    slice_url: Any | Unset = UNSET
    table: ChartDataRestApiGetListSqlaTable | Unset = UNSET
    tags: ChartDataRestApiGetListTag | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_changed_by, Unset):
            ...
            changed_by = ChartDataRestApiGetListUser.from_dict(_changed_by)
        ...
        if isinstance(_created_by, Unset):
            ...
            created_by = ChartDataRestApiGetListUser1.from_dict(_created_by)
        ...
        if isinstance(_dashboards, Unset):
            ...
            dashboards = ChartDataRestApiGetListDashboard.from_dict(_dashboards)
        ...
        if isinstance(_last_saved_by, Unset):
            ...
            last_saved_by = ChartDataRestApiGetListUser2.from_dict(_last_saved_by)
        ...
        if isinstance(_owners, Unset):
            ...
            owners = ChartDataRestApiGetListUser3.from_dict(_owners)
        ...
        if isinstance(_table, Unset):
            ...
            table = ChartDataRestApiGetListSqlaTable.from_dict(_table)
        ...
        if isinstance(_tags, Unset):
            ...
            tags = ChartDataRestApiGetListTag.from_dict(_tags)
        ...
        chart_data_rest_api_get_list = cls(
        ...
        chart_data_rest_api_get_list.additional_properties = d
        return chart_data_rest_api_get_list
