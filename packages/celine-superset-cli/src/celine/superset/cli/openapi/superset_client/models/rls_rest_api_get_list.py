...
from ..models.rls_rest_api_get_list_filter_type import (
    RLSRestApiGetListFilterType,
    check_rls_rest_api_get_list_filter_type,
)
...
T = TypeVar("T", bound="RLSRestApiGetList")


@_attrs_define
class RLSRestApiGetList:
    """
    Attributes:
        ...
        filter_type (RLSRestApiGetListFilterType | Unset): filter_type_description
    ...
    filter_type: RLSRestApiGetListFilterType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_type: RLSRestApiGetListFilterType | Unset
        if isinstance(_filter_type, Unset):
            filter_type = UNSET
        else:
            filter_type = check_rls_rest_api_get_list_filter_type(_filter_type)
        ...
        rls_rest_api_get_list.additional_properties = d
        return rls_rest_api_get_list
