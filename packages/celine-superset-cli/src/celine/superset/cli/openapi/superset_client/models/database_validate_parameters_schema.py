...
from ..models.database_validate_parameters_schema_configuration_method import (
    DatabaseValidateParametersSchemaConfigurationMethod,
    check_database_validate_parameters_schema_configuration_method,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.database_validate_parameters_schema_catalog import DatabaseValidateParametersSchemaCatalog
    from ..models.database_validate_parameters_schema_parameters import DatabaseValidateParametersSchemaParameters


T = TypeVar("T", bound="DatabaseValidateParametersSchema")
...
class DatabaseValidateParametersSchema:
    """
    Attributes:
        configuration_method (DatabaseValidateParametersSchemaConfigurationMethod): Configuration_method is used on the
            frontend to inform the backend whether to explode parameters or to provide only a sqlalchemy_uri.
        engine (str): SQLAlchemy engine to use
        catalog (DatabaseValidateParametersSchemaCatalog | Unset): Gsheets specific column for managing label to sheet
            urls
        ...
        id (int | None | Unset): Database ID (for updates)
        ...
        parameters (DatabaseValidateParametersSchemaParameters | Unset): DB-specific parameters for configuration
    ...
    configuration_method: DatabaseValidateParametersSchemaConfigurationMethod
    engine: str
    catalog: DatabaseValidateParametersSchemaCatalog | Unset = UNSET
    ...
    parameters: DatabaseValidateParametersSchemaParameters | Unset = UNSET
    server_cert: None | str | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        configuration_method: str = self.configuration_method
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        configuration_method = check_database_validate_parameters_schema_configuration_method(
            d.pop("configuration_method")
        )

        engine = d.pop("engine")

        _catalog = d.pop("catalog", UNSET)
        catalog: DatabaseValidateParametersSchemaCatalog | Unset
        if isinstance(_catalog, Unset):
            catalog = UNSET
        else:
            catalog = DatabaseValidateParametersSchemaCatalog.from_dict(_catalog)
        ...
        parameters: DatabaseValidateParametersSchemaParameters | Unset
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = DatabaseValidateParametersSchemaParameters.from_dict(_parameters)
        ...
        database_validate_parameters_schema = cls(
            configuration_method=configuration_method,
            engine=engine,
            catalog=catalog,
        ...
        database_validate_parameters_schema.additional_properties = d
        return database_validate_parameters_schema
