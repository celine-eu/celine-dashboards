...
T = TypeVar("T", bound="PostApiV1DatabaseImportBody")


@_attrs_define
class PostApiV1DatabaseImportBody:
    """
    Attributes:
        form_data (File | Unset): upload file (ZIP)
        overwrite (bool | Unset): overwrite existing databases?
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_v1_database_import_body = cls(
            form_data=form_data,
            overwrite=overwrite,
            passwords=passwords,
        ...
        post_api_v1_database_import_body.additional_properties = d
        return post_api_v1_database_import_body
