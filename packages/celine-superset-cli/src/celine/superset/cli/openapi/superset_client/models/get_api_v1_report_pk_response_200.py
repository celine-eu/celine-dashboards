...
if TYPE_CHECKING:
    from ..models.get_api_v1_report_pk_response_200_description_columns import (
        GetApiV1ReportPkResponse200DescriptionColumns,
    )
    from ..models.get_api_v1_report_pk_response_200_label_columns import GetApiV1ReportPkResponse200LabelColumns
    from ..models.report_schedule_rest_api_get import ReportScheduleRestApiGet


T = TypeVar("T", bound="GetApiV1ReportPkResponse200")


@_attrs_define
class GetApiV1ReportPkResponse200:
    """
    Attributes:
        description_columns (GetApiV1ReportPkResponse200DescriptionColumns | Unset):
        id (str | Unset): The item id
        label_columns (GetApiV1ReportPkResponse200LabelColumns | Unset):
        result (ReportScheduleRestApiGet | Unset):
    ...
    description_columns: GetApiV1ReportPkResponse200DescriptionColumns | Unset = UNSET
    id: str | Unset = UNSET
    label_columns: GetApiV1ReportPkResponse200LabelColumns | Unset = UNSET
    result: ReportScheduleRestApiGet | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description_columns, Unset):
            ...
            description_columns = GetApiV1ReportPkResponse200DescriptionColumns.from_dict(_description_columns)
        ...
        if isinstance(_label_columns, Unset):
            ...
            label_columns = GetApiV1ReportPkResponse200LabelColumns.from_dict(_label_columns)
        ...
        if isinstance(_result, Unset):
            ...
            result = ReportScheduleRestApiGet.from_dict(_result)

        show_columns = cast(list[str], d.pop("show_columns", UNSET))

        show_title = d.pop("show_title", UNSET)

        get_api_v1_report_pk_response_200 = cls(
        ...
        get_api_v1_report_pk_response_200.additional_properties = d
        return get_api_v1_report_pk_response_200
