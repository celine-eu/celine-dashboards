...
T = TypeVar("T", bound="ChartRestApiGetListDashboard")


@_attrs_define
class ChartRestApiGetListDashboard:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chart_rest_api_get_list_dashboard = cls(
            dashboard_title=dashboard_title,
            id=id,
        )

        chart_rest_api_get_list_dashboard.additional_properties = d
        return chart_rest_api_get_list_dashboard
