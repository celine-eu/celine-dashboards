...
T = TypeVar("T", bound="DatasetRestApiGetTableColumn")
...
class DatasetRestApiGetTableColumn:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if type_generic is not UNSET:
            field_dict["type_generic"] = type_generic
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_groupby(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        type_generic = d.pop("type_generic", UNSET)
        ...
        dataset_rest_api_get_table_column = cls(
            column_name=column_name,
        ...
        dataset_rest_api_get_table_column.additional_properties = d
        return dataset_rest_api_get_table_column
