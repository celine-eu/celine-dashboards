...
T = TypeVar("T", bound="PermissionViewMenuApiPut")


@_attrs_define
class PermissionViewMenuApiPut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        permission_view_menu_api_put = cls(
            permission_id=permission_id,
            view_menu_id=view_menu_id,
        )

        permission_view_menu_api_put.additional_properties = d
        return permission_view_menu_api_put
