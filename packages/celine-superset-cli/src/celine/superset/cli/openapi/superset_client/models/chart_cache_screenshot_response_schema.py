...
T = TypeVar("T", bound="ChartCacheScreenshotResponseSchema")
...
class ChartCacheScreenshotResponseSchema:
    ...
    Attributes:
        ...
        chart_url (str | Unset): The url to render the chart
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if chart_url is not UNSET:
            field_dict["chart_url"] = chart_url
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        chart_url = d.pop("chart_url", UNSET)
        ...
        chart_cache_screenshot_response_schema = cls(
            cache_key=cache_key,
            chart_url=chart_url,
            image_url=image_url,
        ...
        chart_cache_screenshot_response_schema.additional_properties = d
        return chart_cache_screenshot_response_schema
