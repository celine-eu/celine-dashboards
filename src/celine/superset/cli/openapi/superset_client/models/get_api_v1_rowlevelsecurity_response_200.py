...
if TYPE_CHECKING:
    from ..models.get_api_v1_rowlevelsecurity_response_200_description_columns import (
        GetApiV1RowlevelsecurityResponse200DescriptionColumns,
    )
    from ..models.get_api_v1_rowlevelsecurity_response_200_label_columns import (
        GetApiV1RowlevelsecurityResponse200LabelColumns,
    )
    from ..models.rls_rest_api_get_list import RLSRestApiGetList


T = TypeVar("T", bound="GetApiV1RowlevelsecurityResponse200")


@_attrs_define
class GetApiV1RowlevelsecurityResponse200:
    """
    Attributes:
        count (float | Unset): The total record count on the backend
        description_columns (GetApiV1RowlevelsecurityResponse200DescriptionColumns | Unset):
        ids (list[str] | Unset): A list of item ids, useful when you don't know the column id
        label_columns (GetApiV1RowlevelsecurityResponse200LabelColumns | Unset):
        ...
        result (list[RLSRestApiGetList] | Unset): The result from the get list query
    """

    count: float | Unset = UNSET
    description_columns: GetApiV1RowlevelsecurityResponse200DescriptionColumns | Unset = UNSET
    ids: list[str] | Unset = UNSET
    label_columns: GetApiV1RowlevelsecurityResponse200LabelColumns | Unset = UNSET
    list_columns: list[str] | Unset = UNSET
    list_title: str | Unset = UNSET
    order_columns: list[str] | Unset = UNSET
    result: list[RLSRestApiGetList] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description_columns, Unset):
            ...
            description_columns = GetApiV1RowlevelsecurityResponse200DescriptionColumns.from_dict(_description_columns)
        ...
        if isinstance(_label_columns, Unset):
            ...
            label_columns = GetApiV1RowlevelsecurityResponse200LabelColumns.from_dict(_label_columns)
        ...
        if _result is not UNSET:
            ...
            for result_item_data in _result:
                result_item = RLSRestApiGetList.from_dict(result_item_data)

                result.append(result_item)

        get_api_v1_rowlevelsecurity_response_200 = cls(
            count=count,
        ...
        get_api_v1_rowlevelsecurity_response_200.additional_properties = d
        return get_api_v1_rowlevelsecurity_response_200
