...
T = TypeVar("T", bound="PostApiV1ChartImportBody")


@_attrs_define
class PostApiV1ChartImportBody:
    """
    Attributes:
        form_data (File | Unset): upload file (ZIP)
        overwrite (bool | Unset): overwrite existing charts?
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_v1_chart_import_body = cls(
            form_data=form_data,
            overwrite=overwrite,
            passwords=passwords,
        ...
        post_api_v1_chart_import_body.additional_properties = d
        return post_api_v1_chart_import_body
