...
if TYPE_CHECKING:
    from ..models.get_api_v1_query_pk_response_200_description_columns import (
        GetApiV1QueryPkResponse200DescriptionColumns,
    )
    from ..models.get_api_v1_query_pk_response_200_label_columns import GetApiV1QueryPkResponse200LabelColumns
    from ..models.query_rest_api_get import QueryRestApiGet


T = TypeVar("T", bound="GetApiV1QueryPkResponse200")


@_attrs_define
class GetApiV1QueryPkResponse200:
    """
    Attributes:
        description_columns (GetApiV1QueryPkResponse200DescriptionColumns | Unset):
        id (str | Unset): The item id
        label_columns (GetApiV1QueryPkResponse200LabelColumns | Unset):
        result (QueryRestApiGet | Unset):
    ...
    description_columns: GetApiV1QueryPkResponse200DescriptionColumns | Unset = UNSET
    id: str | Unset = UNSET
    label_columns: GetApiV1QueryPkResponse200LabelColumns | Unset = UNSET
    result: QueryRestApiGet | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description_columns, Unset):
            ...
            description_columns = GetApiV1QueryPkResponse200DescriptionColumns.from_dict(_description_columns)
        ...
        if isinstance(_label_columns, Unset):
            ...
            label_columns = GetApiV1QueryPkResponse200LabelColumns.from_dict(_label_columns)
        ...
        get_api_v1_query_pk_response_200.additional_properties = d
        return get_api_v1_query_pk_response_200
