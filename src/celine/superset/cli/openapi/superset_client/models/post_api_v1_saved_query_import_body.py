...
T = TypeVar("T", bound="PostApiV1SavedQueryImportBody")


@_attrs_define
class PostApiV1SavedQueryImportBody:
    """
    Attributes:
        form_data (File | Unset): upload file (ZIP)
        overwrite (bool | Unset): overwrite existing saved queries?
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_v1_saved_query_import_body = cls(
            form_data=form_data,
            overwrite=overwrite,
            passwords=passwords,
        ...
        post_api_v1_saved_query_import_body.additional_properties = d
        return post_api_v1_saved_query_import_body
