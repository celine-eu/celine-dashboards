...
if TYPE_CHECKING:
    from ..models.log_rest_api_get_list_user import LogRestApiGetListUser


T = TypeVar("T", bound="LogRestApiGetList")
...
class LogRestApiGetList:
    ...
    Attributes:
        ...
        user (LogRestApiGetListUser | Unset):
        user_id (Any | Unset):
    """
    ...
    user: LogRestApiGetListUser | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_user, Unset):
            ...
            user = LogRestApiGetListUser.from_dict(_user)

        user_id = d.pop("user_id", UNSET)

        log_rest_api_get_list = cls(
            action=action,
        ...
        log_rest_api_get_list.additional_properties = d
        return log_rest_api_get_list
