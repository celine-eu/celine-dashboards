...
T = TypeVar("T", bound="ChartDataAggregateOptionsSchemaAggregates")


@_attrs_define
class ChartDataAggregateOptionsSchemaAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        chart_data_aggregate_options_schema_aggregates = cls()

        chart_data_aggregate_options_schema_aggregates.additional_properties = d
        return chart_data_aggregate_options_schema_aggregates
